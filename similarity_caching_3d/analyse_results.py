...
#for d in ["20_0.1_gaussian_real_10000_dual_14_Warship"]:
#for d in ["20_0.01_cache_real_4000_dual_14_Warship_simple"]:
for d in ["20_0.1_cache_real_8000_dual_14_Warship"]:
    keyword = d.split("_")[5] 
    if len(d.split("_")) > 8:
        keyword += "simple"
